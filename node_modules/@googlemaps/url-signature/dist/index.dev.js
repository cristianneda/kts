var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var fails$i = fails$k; // eslint-disable-next-line es-x/no-object-getownpropertysymbols -- required for testing
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$d(fn = input.toString) && !isObject$5(val = call$e(fn, input))) return val;
	  if (isCallable$d(fn = input.valueOf) && !isObject$5(val = call$e(fn, input))) return val;
	  if (pref !== 'string' && isCallable$d(fn = input.toString) && !isObject$5(val = call$e(fn, input))) return val;
	...
	if (NATIVE_WEAK_MAP || shared$1.state) {
	  ...
	  set = function (it, metadata) {
	    if (hasOwn$a(it, STATE)) throw new TypeError$9(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
